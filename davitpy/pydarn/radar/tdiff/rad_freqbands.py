...
#           18000, 18500, 19000, 19500, 20040, 20500],
    ...
    'hok':[9100, 10700, 11000, 13000, 14000, 14300, 14600, 14900, 15200, 15500,
           15800, 16100, ],
    'inv':[9800, 10300, 10600, 11900, 12200, 12500, 13000, 14000, 16000],
...
#    'mcm':[10100, 10700, 11400, 12500, 13700, 14400, 15200, 17000, 18400],
    ...
    'rkn':[8200, 9200, 9900, 10200, 10500, 11200, 11500, 11900, 12200, 13500,
           14200, 17200],
...
#           18500, 19000, 19500, 20040, 20500, 21000],
    ...
    'hok':[9400, 10999, 11300, 13300, 14299, 14599, 14899, 15199, 15499, 15799,
           16099, 16399, ],
    'inv':[10100, 10599, 10900, 12199, 12499, 12799, 13299, 14299, 16299],
...
#    'mcm':[10400, 11000, 11700, 12800, 14000, 14700, 15500, 17300, 18700],
    ...
    'rkn':[8499, 9499, 10199, 10499, 10799, 11499, 11799, 12199, 12499, 13799,
           14499, 17499],
...
class radFreqBands(object):
    ...
    def __init__(self, rad=None):
        ...
        if id_to_code.has_key(rad):
            ...
            assert isinstance(rad, str), \
                logging.error("unknown station ID: {:}".format(rad))
            self.rad_code = rad
            self.stid = None
    ...
    def __str__(self):
        ...
        if len(self.tbands) == 0:
            ...
            for i,bb in enumerate(self.tbands):
                ostr = "{:s}\t\t{:02d} {:.3f}-{:.3f}\n".format(ostr, bb,
                                                               self.tmins[i] *
                                                               1.0e-3, 1.0e-3 *
                                                               self.tmaxs[i])
